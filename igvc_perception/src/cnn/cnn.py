...
class CNN:
    ...
    def __init__(self, subscriber_topic, publisher_topic, model_filename, resize_width, resize_height, force_cpu):
        self.graph = self.load_graph(model_filename)
        config = tf.ConfigProto(
            device_count={'GPU': 1}
        )
        # TODO:Diagnose why force cpu fails
        # if force_cpu:
        #    self.sess = tf.Session(config=config,graph=self.graph)
        # else:
        # TODO: What is allow_growth?
    ...
    # TODO: Explain mechanism behind projection
...
if __name__ == '__main__':
    ...
    # TODO: Check for image resize script
